...
const Address = {
	...
	init: function() {
		...
		if (address && address.length > 0) {
			this.m_address = JSON.parse(address)
		}
		this.onAddListener();
		return true;
	},
	...
	clear: function() {
		...
		vue.util.StringUtils.removeUserDefaults("address_key");
		this.m_address = [];
	},
	...
	saveAddress: function(addrInfo) {
		...
		uni.cclog("======saveAddress==========", addrInfo)
		vue.util.StringUtils.setUserDefaults("address_key", JSON.stringify(this.m_address));
	},
