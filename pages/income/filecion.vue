...
<script>
	...
	export default {
		...
		created() {
			this.dal.Mine.onGetProfitList('filecoin');
		...
		methods: {
			...
			onGetProfitList:function(data){
				console.log("====filecoin===onGetProfitList=====",data)
				if(data && data.asset == "filecoin"){
