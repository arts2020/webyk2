<template>
	<view class="backup-keystore">
		<uni-nav-bar background-color="#FAFBFF" :statusBar="true" :fixed="true" left-icon="back" :title="title_str20" @clickLeft="goBack"></uni-nav-bar>	    
		<view class="box">
		...
		<view class="copy_btn" @tap="goCopy">{{btnstring_copyWord}}</view>
	...
	export default {
		...
		methods:{
			initword(){
				...
				this.btnstring_copyWord = this.getLocalStr("btnstring_copyWord")
